...
export default {
  ...
  data() {
    return {
      resumo: 'Cancelamento Mediante Pedido do Próprio Solicitante',
      status: 'Cancelado',
      detalhes: '',
      // ---
      motivo: '',
  ...
  methods: {
    updateDetalhes() {
      this.detalhes = `Em contato com o usuário o mesmo solicita o cancelamento do chamado devido: ${this.motivo}
Conforme evidência em anexo.`;
