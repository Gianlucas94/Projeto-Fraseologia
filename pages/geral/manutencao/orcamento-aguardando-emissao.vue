<template>
  <div>
    ...
    <div class="uk-grid uk-grid-medium uk-child-width-expand@s uk-margin">
      <div>
        <div class="uk-margin">
          <label for="data" class="uk-form-label required">Previsão de término da atividade</label>
...
export default {
  ...
  data() {
    return {
      resumo: 'Aguardando Emissão de Orçamento',
  ...
  mounted() {
    ...
    this.detalhes = `Identificado que ocorreu uso inadequado do equipamento.
Aguardando emissão do orçamento.
