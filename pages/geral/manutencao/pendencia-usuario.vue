...
export default {
  ...
  data() {
    return {
      resumo: 'Pendência do usuário',
      status: 'Em espera - Aguardando Solicitante',
      detalhes: '',
      // ---
      motivo: '',
      data: '',
  ...
  methods: {
    updateDetalhes() {
      ...
      this.detalhes = `A continuidade do atendimento está pendente do usuário.
Motivo da pendência do usuário: ${this.motivo}.
