<template>
  <div>
    ...
    <div class="uk-grid uk-grid-medium uk-child-width-expand@s uk-margin">
      <div>
        <div class="uk-margin">
          <label for="motivo" class="uk-form-label required">Motivo do acionamento do laboratório</label>
          <select id="motivo" class="uk-select" v-model="motivo" @change="updateDetalhes">
            <option>Enviado equipamento</option>
            <option>Reparo em equipamento</option>
          </select>
        </div>
      </div>
      <div>
...
export default {
  ...
  mounted() {
    ...
    this.detalhes = `Qual o motivo do acionamento do Laboratório: ${this.motivo}
