  ...
  <div>
    ...
    <div class="uk-grid uk-grid-medium uk-child-width-expand@s uk-margin">
      <div>
        ...
        <div class="uk-margin">
          <label for="data-entrega" class="uk-form-label required">Nova atualização</label>
...
Previsão de entrega do aparelho na localidade do usuário: ${this.prazoEntregaHtml} às ${this.hora}
Modelo: ${this.modelo}
IMEI: ${this.imei}
