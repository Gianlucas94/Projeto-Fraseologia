<template>
  <div>
    <ul class="uk-tab" data-uk-tab="{connect:'#chat-opcoes'}">
      <li><a href="#">Início</a></li>
      <li><a href="#">Frases de Strike</a></li>
      <li><a href="#">Finalização</a></li>
    </ul>
    <div id="chat-opcoes" class="uk-switcher">
      <div class="tab-content1">
        ...
        <div class="uk-margin">
          <label id="informacoes-usuario" for="chat">Informações do Usuário</label>
          <textarea id="informacoes-usuario" class="uk-textarea" rows="9" style="height: auto" readonly v-model="informacoesUsuario"></textarea>
        </div>

        <div class="uk-margin">
          <label id="acesso-remoto" for="chat">Logar no equipamento?</label>
